...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الأعدادت </h4><span
        ...
        <div class="card mg-b-20">
            ...
            <div class="card-header pb-0">
                ...
                <a class="modal-effect btn btn-outline-primary continar:block " data-effect="effect-fall"
                    data-toggle="modal" href="#exampleModal"> <i class="fas fa-plus"></i> اضافه منتج</a>
                    ...
                    <table id="example1" class="table key-buttons text-md-nowrap" data-page-length='50';>
                        <thead>
                            <tr>
                                ...
                                <th class="border-bottom-0">اسم االمنتج</th>
